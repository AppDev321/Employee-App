...
class LoginClassStateful extends State<LoginClass> {
  ...
  Widget _uiSetup(BuildContext context) {
    ...
    _loginViewModel.getFinerPrintStatus();
    isBiometericEnable = _loginViewModel.biometericStatus;
                        ...
                        ? Center(
                            child: IconButton(
                              onPressed: ()  {
                                ...
                                _loginViewModel.authenticateWithBiometrics().then((value) {
...
// _onLoginButtonPress(email, pass)
  }
  ...
  saveUserToken(String? token) async {
    ...
    await controller.setEmail(_emailController.text);
    await controller.setPassword(_passwordController.text);
