 ...
 late AvailabilityRequest deletedItemRequest;
  ...
  void initState() {
    ...
    _progressDialog?.hideOpenDialog();
      ...
      var checkErrorApiStatus = _availabilityViewModel.getIsErrorRecevied();   ///API ki Error
    ...
    if(isUpdateClick) {
      if (_availabilityViewModel.getRequestStatus()) { //Update ka error
        setState(() {
          _errorMsg = "";
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            SizedBox(height: 10,),
                              InkWell(
                                onTap: (){
                                Get.to(() => ViewAvailability(availabilityRequest:item,isEditableView:false));
                                },
                                child: TextColorContainer(
                                    label: "View Details", color: primaryColor,icon:Icons.remove_red_eye),
                              ),
                              ...
                              InkWell(
                                  ...
                                  Controller().showConfirmationMsgDialog(
                                    ...
                                    if(value)
                                    {
                                      ...
                                      _progressDialog?.showLoadingDialog();
                                       _availabilityViewModel.deleteAvailabilityRequest(item.code.toString());
                                ...
                                child: TextColorContainer(
                                  label: "Del", color: claimedShiftRejectColor,icon: Icons.delete,),
                              ),
              ...
              children: [
               ...
               Expanded(
                 child: Padding(
                        ...
                        child:
                        CustomTextWidget(  text:value,color: Colors.grey,size: 16,)),
               ),
